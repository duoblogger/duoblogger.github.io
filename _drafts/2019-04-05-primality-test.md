...
এই সমীকরণটিকে একটি প্রাইমালিটি টেস্ট হিসেবে ব্যবহার করা যায়। আমরা যে কোন একটি পূর্ণসংখ্যা $$ 2 \leq a \leq p-2 $$  নিব এবং যাচাই করব যে এ সমীকরণটি এই পূর্ণসংখ্যার জন্য সত্য হয় কিনা।  যদি এটা সত্য না হয়, অর্থাৎ $$ a^{p-1} \not\equiv 1 $$ $$(mod$$ $$p)$$, আমরা জানি যে $$p$$ মৌলিক নয়। এক্ষেত্রে বেস $$a$$ কে $$p$$ এর যোগিক সংখ্যা হওয়ার ফার্মার উইটনেস বলা হয়।


কিন্তু এখানে একটি ছোট সমস্যা আছে। এই সমীকরণটি একটি মৌলিক সংখ্যার জন্য সর্বদা সত্য হলেও, কোনো একটি যৌগিক সংখ্যার জন্য সর্বদা মিথ্যা হয় না। তাই সমীকরণটি মিথ্যা হলে আমরা বলতে পারি যে $$p$$ অবশ্যই যৌগিক কিন্তু যদি এই সমীকরণটি সত্য হয় তাহলে আমরা নিশ্চিত ভাবে বলতে পারি না যে $$p$$ মৌলিক। আমরা বলতে পারি যে এটি সম্ভবত মৌলিক। যদি বেস $$a$$ এর জন্য সমীকরণটি সত্য হওয়ার পরেও এটি যৌগিক সংখ্যা হয় তাহলে আমরা বেসটিকে ফার্মার লায়ার বলি।

সকল বেস এর জন্য চেক করে আমরা এটা প্রমাণ করতে পারি যে সংখ্যাটি আসলেই মৌলিক। কিন্তু ব্যবহারিক ক্ষেত্রে এটি করা হয় না কারণ এতে অনেক সময় ব্যয় হয়।বরং দৈব চয়ন এর মাধ্যমে কয়েকটি বেস এর জন্য যাচাই করেই আমরা মোটামুটি নিশ্চিত হতে পারি। যদি কোনো ফার্মার উইটনেস না পাওয়া যায় তাহলে বলা যায় যে এটি মৌলিক হওয়া সম্ভাবনাই বেশি।
